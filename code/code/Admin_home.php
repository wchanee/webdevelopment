    ...
    <body>
        ...
        <header>
            ...
            <div class="content">
                ...
                <a href="Admin_about.php"> Explore More</a> 
            </div>
              ...
              <div class="sec-section">
                  <div class="sec-container">
                    <div class="sec-actionBox">
                      ...
                      <button class="sec-btn"><a href="Admin_about.php"> About Us</a></button>
              ...
              <div class="sec-section">
                  <div class="sec-container">
                    <div class="sec-actionBox">
                      ...
                      <button class="sec-btn"><a href="Admin_event.php"> News and Events</a></button>
                      ...
                      <div class="sec-section">
                          <div class="sec-container">
                            <div class="sec-actionBox">
                              ...
                              <button class="sec-btn"><a href="Admin_contact.php"> Contact</a></button>
